...
BEGIN {
    ...
    die "You must set the CONTEXT_ROOT variable before instantiating Context.pm"
      unless exists $ENV{CONTEXT_ROOT};
}
...
sub BUILD {
    ...
    #$self->path_to_bin("$ENV{CONTEXT_ROOT}/usr/local/bin")
